  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const crossingData = {
        ...
        cabinType: formData.get("cabinType") as string,
    ...
    try {
      const res = await fetch("/api/booking/tickets/ferry", {
        method: "POST",
        headers: {
      ...
      <main className="flex-grow">
        <div className="bg-lta-purple py-10 md:py-20 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative z-10 text-white">
            <h1 className="text-3xl md:text-5xl font-black mb-4">{t.ticketsBookingPage.ferryTitle}</h1>
            <p className="text-white/80 max-w-2xl text-lg">{t.ticketsBookingPage.ferrydescription}</p>
          </div>
        </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select name="cabinType" required>
                            <SelectTrigger
                              className={
                                formErrors.cabinType ? "border-red-500" : ""
                              }
                            >
                              <SelectValue
                                placeholder={
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .cabinType.placeholder
                                }
                              />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="inside">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .cabinType.options.inside
                                }
                              </SelectItem>
                              <SelectItem value="outside">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .cabinType.options.outside
                                }
                              </SelectItem>
                              <SelectItem value="deluxe">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .cabinType.options.deluxe
                                }
                              </SelectItem>
                              <SelectItem value="suite">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .cabinType.options.suite
                                }
                              </SelectItem>
                              <SelectItem value="none">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .cabinType.options.none
                                }
                              </SelectItem>
                            </SelectContent>
                          </Select>
                          {formErrors.cabinType && (
                            <p className="text-red-500 text-xs mt-1">
                              {formErrors.cabinType}
                            </p>
                          )}
                        ...
                        <div className="space-y-2">
                          ...
                          <Select name="vehicleType" defaultValue="none">
                            <SelectTrigger>
                              <SelectValue
                                placeholder={
                                  t.ticketsBookingPage.crossingAndCabinInfo
                            ...
                            <SelectContent>
                              <SelectItem value="none">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .vehicleType.options.none
                                }
                              </SelectItem>
                              <SelectItem value="car">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .vehicleType.options.car
                                }
                              </SelectItem>
                              <SelectItem value="suv">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .vehicleType.options.suv
                                }
                              </SelectItem>
                              <SelectItem value="van">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .vehicleType.options.van
                                }
                              </SelectItem>
                              <SelectItem value="motorcycle">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .vehicleType.options.motorcycle
                                }
                              </SelectItem>
                              <SelectItem value="other">
                                {
                                  t.ticketsBookingPage.crossingAndCabinInfo
                                    .vehicleType.options.other
                                }
                              </SelectItem>
                            </SelectContent>
                          </Select>
                ...
                <Card>
                  <CardContent className="p-6">
                    <h3 className="font-semibold text-lg mb-4">
                      {t.ticketsBookingPage.ferryWhyBookWithUs.title}
                    </h3>
                    <ul className="space-y-3">
                      {t.ticketsBookingPage.ferryWhyBookWithUs.items.map(
                        (item, index) => (
